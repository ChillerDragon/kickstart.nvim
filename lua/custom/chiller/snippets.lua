function chiller_snippets(luasnip)
      ...
      luasnip.add_snippets("eruby", {
        ...
        luasnip.snippet("fw", {
          ...
          luasnip.text_node({"", ""}),
          luasnip.insert_node(1),
          luasnip.text_node({'', '  <%= f.label :query, "Search for:" %>'}),
          luasnip.text_node({'', '  <%= f.text_field :query %>'}),
          luasnip.text_node({"", '  <%= f.submit "Search" %>'}),
          luasnip.text_node({'', ''}),
          luasnip.text_node({"<% end %>"})
        }),
        luasnip.snippet("fwm", {
          ...
          luasnip.text_node({"", ""}),
          luasnip.insert_node(1),
          luasnip.text_node({'', '  <%= f.text_field :title %'}),
          luasnip.text_node({'', '  <%= f.text_area :body, size: "60x10" %>'}),
          luasnip.text_node({"", '  <%= f.submit %>'}),
          luasnip.text_node({'', ''}),
          luasnip.text_node({"<% end %>"})
        }),
        luasnip.snippet("end", {
